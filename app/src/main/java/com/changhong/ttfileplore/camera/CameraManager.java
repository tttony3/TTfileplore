...
package com.changhong.ttfileplore.camera;
...
public final class CameraManager {
     ...
     * {@link com.changhong.ttfileplore.activities.madmatrix.zxing.android.CaptureActivity}
     */
    ...
    private static int findDesiredDimensionInRange(int resolution, int hardMin,
                                                   int hardMax) {
        int dim = 5 * resolution / 8; // Target 5/9 of each dimension
        if (dim < hardMin) {
            return hardMin;
        }
        if (dim > hardMax) {
