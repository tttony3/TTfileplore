...
import com.changhong.ttfileplore.activities.CaptureActivity;
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            BitmapDrawable drawable = (BitmapDrawable) (getResources().getDrawable(R.drawable.qrcode_scan_line));
            Bitmap scan_line = null;
            if (drawable != null)
                scan_line = drawable.getBitmap();
            assert scan_line != null;
            canvas.drawBitmap(scan_line,
                    null, lineRect, paint);
            ...
            if ((CaptureActivity.currentState != null)
                ...
                canvas.drawText(
                        ...
                        frame.left + 8, (frame.bottom + (float) 40
                                * density), paint);
            ...
            if ((CaptureActivity.currentState != null)
                ...
                canvas.drawText(getResources().getString(R.string.scan_qrcode),
                        frame.left - 20, (frame.bottom + (float) 40
                                * density), paint);
            }
